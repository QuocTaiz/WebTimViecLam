...
<html lang="en">
  <head>
    ...
    <title>TheJobs - Thông tin công ty</title>
    ...
    <header class="page-header bg-img size-lg" style="background-image: url(${pageContext.request.contextPath}/view/assets/img/bg-banner2.jpg)">
      <div class="container">
        <div class="header-detail">
          ...
          <hr>
          <p class="lead">${cpn.sort_desc}</p>

          <ul class="details cols-3">
            <li>
              <i class="fa fa-map-marker"></i>
              <span>${cpn.address}</span>
            </li>
            
            <li>
              <i class="fa fa-users"></i>
              <span>${cpn.num_employees} thành viên</span>
            </li>
            
            <li>
              <i class="fa fa-globe"></i>
              <span>${cpn.website}</span>
            </li>
