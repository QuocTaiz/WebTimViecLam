...
<html lang="en">
  <head>
    ...
    <title>TheJobs - Quản lý hồ sơ</title>
  ...
  <body class="nav-on-header smart-nav bg-alt">
	        ...
	        <c:if test="${role eq 'recruiter'}">
          	...
          	<c:if test="${role eq 'jobseeker'}">
	              ...
	              <ul>
	              	...
	              	<li><a href="/PBL3/resume-manage" class="active">Quản lý hồ sơ</a></li>
    ...
    <header class="page-header bg-img size-lg" style="background-image: url(${pageContext.request.contextPath}/view/assets/img/bg-banner2.jpg)">
      <div class="container no-shadow">
        ...
        <p class="lead text-center">Đây là danh sách các hồ sơ bạn đã tạo. Bạn có thể chỉnh sửa hoặc xoá chúng, hoặc là tạo thêm một cái mới.</p>
      </div>
    </header>
    <!-- END Page header -->
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xs-12 text-right">
              <br>
              <a class="btn btn-primary btn-sm" href="view/resume-add.jsp">Thêm hồ sơ</a>
            </div>

			<c:forEach var="i" items="${listCV}">
				<!-- Resume item -->
	            <div class="col-xs-12">
	              <div class="item-block">
	                ...
	                <footer>
	                  ...
	                  <div class="action-btn">
	                    ...
	                    <a class="btn btn-xs btn-danger" href="/PBL3/resume-delete?id_cv=${i.id}">Xoá</a>
	                  </div>
	                </footer>
	              </div>
	            </div>
