  ...
  <body class="nav-on-header smart-nav bg-alt">
            ...
            <c:if test="${role eq 'admin'}">
		        <li>
		            ...
		            <ul>
		              ...
		              <li><a href="/PBL3/job-inspect" class="active">Duyệt bài đăng</a></li>
		            </ul>
		        </li>
	        </c:if>
    ...
    <header class="page-header bg-img size-lg" style="background-image: url(${pageContext.request.contextPath}/view/assets/img/vaphongweb.jpg)">
      <div class="container no-shadow">
        <h1 class="text-center">Duyệt bài đăng</h1>
        <p class="lead text-center">Duyệt các bài đăng để nó hiển thị trên hệ thống</p>
      </div>
    </header>
    <!-- END Page header -->
	            ...
	            <div class="col-xs-12">
	              <div class="item-block">
	                ...
	                <footer>
	                  ...
	                  <form action="/PBL3/job-inspect" method="post">
	                  	<input type="hidden" name="id_job" value="${i.id}">
	                    <button class="btn btn-xs btn-success" type="submit" name="status" value="Đã duyệt">Duyệt</button>
	                    <button class="btn btn-xs btn-danger" type="submit" name="status" value="Xoá">Xóa</button>
	                  </form>
	                  </div>
	                </footer>
	              </div>
